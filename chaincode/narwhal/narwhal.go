...
/*
 * The Init method is called when the Smart Contract "narwhal" is instantiated by the blockchain network
...
/*
 * The Invoke method is called as a result of an application request to run the Smart Contract "narwhal"
